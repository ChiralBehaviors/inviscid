"""honeycomb_topology -- Topology rewired onto the honeycomb, and what the array's mobility is.
...
from analysis.retired.rig_lock import honeycomb_exchange as W
from analysis.retired.rig_lock.array_linkage import (PAIRS, assemble_free, build_topologies,
