...
from analysis.model.jitterbug import corners  # noqa: F401  (imported for provenance)
from analysis.retired.rig_lock.array_linkage import verts, PAIRS, Topology
...
def _rows():
    ...
    from analysis.retired.rig_lock.quasistatic_crank import fold_halves
    dev = 0.0
