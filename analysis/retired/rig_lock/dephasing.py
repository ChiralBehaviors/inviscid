...
_MODULE = "analysis.retired.rig_lock.dephasing"
from scipy.optimize import brentq, linprog

from analysis.retired.rig_lock.array_linkage import (A_ICO, DIAGONALS, STRUT_LEN, Topology, _classes,
                                _class_positions, _hat, build_topologies,
                                diagonal_generator_pairs, dverts_exact, verts,
                                PAIRS)
from analysis.model.jitterbug import rot
