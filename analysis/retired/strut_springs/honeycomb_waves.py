"""honeycomb_waves -- the VE/octa rectified cubic honeycomb, and the two waves it carries.
...
from analysis.retired.rig_lock.array_linkage import STRUT_LEN, verts
...
def h1_packing():
    ...
    from analysis.retired.rig_lock.array_linkage import ANTI
    off = v0[0] - v0[ANTI[0]]
