...
public class Edge {
     ...
     */
    public Point3D[] getEndLocations() {
     ...
     *             If end is not one of the endpoints of this edge.
     */
    public Point3D getOtherLocation(int end) {
    ...
    public double length() {
        Point3D diff = mesh.vertexPositions.get(ends[0]).subtract(mesh.vertexPositions.get(ends[1]));
    ...
    public Point3D midpoint() {
        Point3D midpt = mesh.vertexPositions.get(ends[0]).subtract(mesh.vertexPositions.get(ends[1]));
        return midpt.multiply(0.5);
    }
...
//        Point3D[] endpoints = getEndLocations();
