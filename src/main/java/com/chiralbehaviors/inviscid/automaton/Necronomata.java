...
public class Necronomata implements Iterable<Point3i>, QuantaField {
     ...
     * com.chiralbehaviors.inviscid.automaton.lga.CollisionSweep#tick(int)} is the
     ...
     * Necronomata} method: {@link com.chiralbehaviors.inviscid.automaton.lga.ContactScan}
     * enumerates contacts (bead inviscid-0nx.13), {@link
     * com.chiralbehaviors.inviscid.automaton.lga.CollisionSweep} resolves and
     * records them against the frozen pre-tick snapshot (bead
     * inviscid-0nx.14), and {@link
     * com.chiralbehaviors.inviscid.automaton.lga.HybridAutomaton} composes that
     ...
     * {@link com.chiralbehaviors.inviscid.automaton.lga.FccNeighborhood} for the
     ...
     * com.chiralbehaviors.inviscid.automaton.measure.SpectrumAnalyzer}'s class
