 ...
 * {@link com.chiralbehaviors.inviscid.automaton.measure.ConservationAudit.Violation}
 * uses ({@code cell}, {@code cube}, {@code member} as separate axes) and
 * {@code com.chiralbehaviors.inviscid.automaton.lga.Contact} carries
...
public class CollisionStatistics {
     ...
     * {@code com.chiralbehaviors.inviscid.automaton.lga.Contact}'s fields
     * ({@code cellA}, {@code cubeA}, {@code memberA}, {@code cellB},
