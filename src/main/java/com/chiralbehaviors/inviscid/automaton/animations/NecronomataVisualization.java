...
package com.chiralbehaviors.inviscid.automaton.animations;
...
import com.chiralbehaviors.inviscid.automaton.lga.VisualizationCellIndex;
    ...
    private void createCellAnimators(CubicGrid grid, Material[] materials,
        ...
        automata.forEach(location -> {
            ...
            for (int cube = 0; cube < 5; cube++) {
                ...
                MeshView view;
                Transform position = grid.positionTransform(location.x
